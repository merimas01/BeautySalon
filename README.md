...
- Run **desktop_app.exe** from Release folder in the zipped archive fit-build-2025-03-06.zip
...
- Drag and drop the **app-release.apk** file (from flutter-apk folder in the zipped archive fit-build-2025-03-06.zip) into the Emulator, in order to install the application
